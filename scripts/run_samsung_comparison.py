...
from picnnt.experiments import MODEL_REGISTRY, build_samsung_data, run_seeds, summarize
...
device = get_device()
print(f"device={device}  n_seeds={args.n_seeds}  stride={args.stride}")

data = build_samsung_data(args.raw_dir, seq_len=args.seq_len, stride=args.stride)
